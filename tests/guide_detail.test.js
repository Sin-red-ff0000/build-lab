...
assert((refs.tunings||[]).length===24,`tuning guide refs ${(refs.tunings||[]).length}`);
...
assert((refs.styles||[]).length===38,`style guide refs ${(refs.styles||[]).length}`);
assert((refs.linkmodes||[]).length===4,`link mode guide refs ${(refs.linkmodes||[]).length}`);
assert((refs.behaviors||[]).length===36,`behavior guide refs ${(refs.behaviors||[]).length}`);
