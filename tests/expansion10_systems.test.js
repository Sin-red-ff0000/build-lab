...
// v0.9セーブ移行
const migrated=BL.Store.mergeDefaults({version:9,bossDefeated:true,deck:[...D.DEFAULT_DECK],unlockedSystems:{},unlockedCards:{},unlockedRelics:{}});assert(migrated.version===25,'save version did not migrate to 20');assert(migrated.unlockedSystems.character_style,'boss1-cleared v0.9 save did not receive character style system');
