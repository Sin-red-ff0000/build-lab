...
assert.equal(BL.Store.state.version,21);assert.equal(BL.Store.state.stats.wins,9);assert.equal(BL.Store.state.alchemy.enabled,false);assert(BL.Store.state.unlockedSystems.rune);
