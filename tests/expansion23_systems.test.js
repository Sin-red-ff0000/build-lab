...
assert.equal(migrated.version,23);assert.equal(migrated.alchemy.allocation.fire,6);assert(migrated.unlockedSystems.rune&&migrated.unlockedSystems.arcana);
