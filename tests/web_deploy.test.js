...
assert(/styles\/base\.css\?v=0\.16\.0/.test(html),'CSS cache buster missing');
assert(/js\/data\/guides\.js\?v=0\.16\.0/.test(html),'guide data cache buster missing');
assert(/js\/ui\/guideView\.js\?v=0\.16\.0/.test(html),'guide view cache buster missing');
assert(/js\/app\.js\?v=0\.16\.0/.test(html),'app cache buster missing');
...
assert(state.includes("const KEY='build_lab_proto_v16'"),'v16 save key missing');
assert(state.includes("'build_lab_proto_v15'"),'v15 migration key missing');
