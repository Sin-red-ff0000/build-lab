...
assert(/styles\/base\.css\?v=0\.18\.0/.test(html),'CSS cache buster missing');
assert(/js\/data\/guides\.js\?v=0\.18\.0/.test(html),'guide data cache buster missing');
assert(/js\/ui\/guideView\.js\?v=0\.18\.0/.test(html),'guide view cache buster missing');
assert(/js\/app\.js\?v=0\.18\.0/.test(html),'app cache buster missing');
...
assert(state.includes("const KEY='build_lab_proto_v18'"),'v18 save key missing');
assert(state.includes("'build_lab_proto_v17'"),'v17 migration key missing');
