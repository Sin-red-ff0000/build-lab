...
migrated=BL.Store.mergeDefaults({version:8,boss3Defeated:true,deck:[...D.DEFAULT_DECK],unlockedCards:{},unlockedRelics:{},unlockedSystems:{}});assert(migrated.version===21,'save version did not migrate to 20');assert(migrated.unlockedSystems.deck_doctrine,'第3ボス既撃破セーブで構築規格システムが復元されません');assert(migrated.unlockedDoctrines.compact&&migrated.unlockedDoctrines.expanded&&migrated.unlockedDoctrines.singleton,'第3ボス初期規格が復元されません');
