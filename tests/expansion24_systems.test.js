...
let s=BL.Store.mergeDefaults({version:23,boss4Defeated:true,alchemy:{enabled:true,allocation:{fire:6,earth:6},recipes:['lava'],hold:[]}});assert.equal(s.version,25);assert.equal(s.alchemy.allocation.fire,6);
